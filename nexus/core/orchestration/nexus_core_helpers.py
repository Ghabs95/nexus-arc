...
def get_git_platform(repo: str = None, project_name: str = None, token_override: str | None = None):
    ...
    token = override_token or (os.getenv(token_var) if allow_service_token_fallback else "")
...
async def handle_approval_gate(
    ...
    def _notify_approval_required(**kwargs):
        from nexus.core.integrations.notifications import notify_approval_required
